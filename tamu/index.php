...
if($_SESSION['username']){
    $cari_akun=mysqli_query($conn,"SELECT * FROM tbl_tamu where username='$akun'");
...
?>
    ...
    <head>
        ...
        <title>Hallo, <?php echo $data_akun['nama_tamu'];?></title>
    </head>
    <body>
        <nav class="navbar navbar-light bg-light fixed-top">
            <div class="container">
                <a class="navbar-brand" href="#">Hallo, <?php echo $data_akun['nama_tamu'];?></a>
